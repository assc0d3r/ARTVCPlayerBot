...
async def start(client, message):
    ...
    buttons = [
        [
            InlineKeyboardButton('⚙️ Update Channel', url='https://t.me/assimilat0r'),
            InlineKeyboardButton('🧩 Source', url='https://t.me/assimilat0r')
        ],
        [
...
async def repo_(client, message):
    buttons = [
        [
            InlineKeyboardButton('🧩 Repository', url='https://t.me/assimilat0r'),
            InlineKeyboardButton('⚙️ Update Channel', url='https://t.me/assimilat0r'),     
        ],
        [
